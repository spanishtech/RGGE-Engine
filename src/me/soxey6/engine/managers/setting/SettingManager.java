...
public class SettingManager {
	 ...
	 * 
	 * @param String
	 *            name - The name that the setting will be retrieved with
	 * @param Setting
	 *            setting - The setting to store
	 */
	...
	public void addSetting(Setting setting) {
		Logger.getLogger().log(Logger.getLogger().DEBUG,
				"Adding setting " + setting.getName());
	 ...
	 * 
	 * @param String
	 *            name - The name that the setting will be retrieved
	 */
	...
	public static void setSettings(SettingManager settings) {
