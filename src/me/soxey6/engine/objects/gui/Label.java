...
public class Label extends GuiElement
{
	...
	public Label(String name, Gui gui, float posX, float posY, String text, int size)
	{
	...
	public Label(String name, Gui gui, float posX, float posY, String text, int size,boolean centered)
	{
		super(name, gui, posX, posY, 0, 0);
		this.size=size;
		this.text=text;
